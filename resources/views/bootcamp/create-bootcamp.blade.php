            ...
            <div class="flex-between">
                ...
                <div class="box-kiri">
                    ...
                    <form action="/create-bootcamp" method="post" enctype="multipart/form-data">
                        ...
                        <input id="myFile" type="file" name="document" hidden><br>
                        <label for="myFile" class="custom-upload">
                          <div style="padding : 13px;" class="align-mid">
                            <img src="images/upload.png" alt="logo-upload" style="margin-right : 20px; opacity : 0.6"><span style="color : rgb(171, 171, 171);" id="file-choose">Upload Bootcamp Proposal</span>
                          </div>
                        </label><br>
